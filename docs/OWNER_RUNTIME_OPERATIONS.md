...
not remain visible as current. #462 / PR #502 implements this contract on the
retained legacy Export/Backup surface, including stale-request supersession;
this runbook does not add a second UI state system.
