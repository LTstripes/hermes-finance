...
1. прочитать этот файл, точную task-card из активного release-файла (например, `docs/releases/0.2.0.md`) и связанные ADR/разделы спецификации; `docs/HERMES_TASKS.md` использовать как исторический MVP reference, когда это нужно для контекста;
