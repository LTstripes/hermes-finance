...
Версия этого release candidate — **0.3.0**.
...
## Известные ограничения 0.3.0

- только один локальный пользователь, без auth/cloud/VPS/HTTPS;
- автоматических MOEX-котировок нет — цены вводятся вручную;
...
- [`docs/releases/0.3.0.md`](docs/releases/0.3.0.md) — current release backlog/checkpoint;
