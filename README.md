...
Проект развивается небольшими последовательными задачами. Сейчас доступен минимальный локальный FastAPI backend с health endpoint; frontend, база данных и финансовая логика ещё не инициализированы.
