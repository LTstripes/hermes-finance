...
#460 bounded verified retention, #461 isolated DR rehearsal and #462 restore-state reload are now integrated on canonical `main`. The #461 implementation required a post-merge Windows process-disposition fix in PR #499; #462 / PR #502 then closed the stale post-restore month-state lifecycle race. Final #462 canonical checkpoint `5bb52b8e1a8394e389968514deaeb4faf8cc5a19` passed exact-main CI #904 / `35771083594`. All planned implementation children under #417 are complete. Real protected off-device publication, independently held recovery material and the first Owner-controlled DR rehearsal remain pending Owner gates.
...
- #417 — implementation is complete through #462; only the final Owner-controlled protected off-device recovery point, independent recovery material and clean DR rehearsal remain;
