...
Это дерево содержит содержимое релиза **0.6.0**. Опубликованная идентичность релиза определяется неизменяемым Git-тегом и GitHub Release.
...
- [`docs/releases/0.6.0.md`](docs/releases/0.6.0.md) — 0.6 release record;
