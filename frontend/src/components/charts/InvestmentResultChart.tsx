    ...
    <section aria-label="Результат по счетам и классам активов" className="investment-result">
      ...
      <div className="investment-result__tables">
        ...
        <p className="chart-note">
          Здесь показан денежный результат: полученные купоны, дивиденды и проценты после удержаний,
          реализованный результат сделок и изменение стоимости открытых позиций. Погашения
          облигаций и пополнения не считаются доходом.
        </p>
      </div>
    </section>
  );
