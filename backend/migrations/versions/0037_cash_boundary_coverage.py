...
Revision ID: 0037_cash_boundary_coverage
...
revision = "0037_cash_boundary_coverage"
...
def downgrade() -> None:
    ...
    if count:
        raise RuntimeError(
            "cannot downgrade 0037_cash_boundary_coverage while coverage evidence exists"
        )
    op.drop_index(
        "ix_cash_boundary_coverages_account_interval",
