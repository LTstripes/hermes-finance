...
Revision ID: 0038_transfer_reconciliation_evidence
Revises: 0037_cash_boundary_coverage
...
revision = "0038_transfer_reconciliation_evidence"
down_revision = "0037_cash_boundary_coverage"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    if count:
        raise RuntimeError(
            "cannot downgrade 0038_transfer_reconciliation_evidence while evidence exists"
        )
    op.drop_index(
        "ix_external_transfer_reconciliation_evidence_transfer",
