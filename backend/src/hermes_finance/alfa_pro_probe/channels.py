"""Explicit Alfa PRO read-only channel allowlist and trading denylist.
...
ALLOWED_BUS_CHANNELS: Final = frozenset(
    {
        "#ConnectionState.Bus",
        "#Data.Bus.ClientAccountEntity",
        "#Data.Bus.ClientSubAccountEntity",
        "#Data.Bus.SubAccountRazdelEntity",
        "#Data.Bus.ClientPositionEntity",
        "#Data.Bus.ClientBalanceEntity",
        "#Data.Bus.ClientOperationEntity",
        "#Data.Bus.AssetInfoEntity",
    }
)
...
ENTITY_PRIMARY_KEY: Final = {
    ...
    "ClientOperationEntity": "IdOperation",
