...
COLUMN_ALIASES: dict[str, tuple[str, ...]] = {
    "seq": ("№", "n", "номер п/п", "№ п/п"),
    "depo_account": ("счет депо", "№ счета депо", "номер счета депо", "счет депо клиента"),
    "agreement": ("номер договора", "договор", "соглашения"),
    ...
    "per_unit": (
        ...
        "сумма на одну цб",
        "на одну цб",
        "размер выплаты на 1 ц.б.",
    ),
    "gross": (
        "общая сумма начисленной выплаты",
    ...
    "d1": ("d1",),
    "d2": ("d2",),
    "tax_rate": ("ставка налога", "налоговая ставка, %", "ставка"),
    "tax": (
        "удержанная сумма налога, руб.",
        "удержанная сумма налога руб",
    ...
    "beneficiary_account": ("счет получателя дохода", "счет получателя", "банковский счет"),
    "beneficiary_bank": ("банк получателя дохода", "банк получателя", "банк"),
}
