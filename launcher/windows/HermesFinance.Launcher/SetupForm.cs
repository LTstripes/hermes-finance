...
public sealed class SetupForm : Form
{
    ...
    private void BuildLayout()
    {
        ...
        var intro = new Label
        {
            Text = "Выберите подготовленные каталоги. Stable — pinned release v0.8.0 и production-данные; Preview — изолированные данные, никогда не production. Ручной JSON не нужен.",
            Dock = DockStyle.Fill,
            AutoSize = false,
        };
